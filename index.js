...
require("dotenv").config( { path: '/data/data/com.termux/files/home/test3/shapes-api/examples/social/shape-guilded/test3.env' } ); // To load environment variables from .env
